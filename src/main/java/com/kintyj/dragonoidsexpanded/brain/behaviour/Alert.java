...
public class Alert<E extends LivingEntity> extends ExtendedBehaviour<E> {
    ...
    protected Predicate<LivingEntity> canInformPredicate = target -> false;
    ...
    protected Predicate<LivingEntity> canInformInternalPredicate = target -> target instanceof IAlertable ? canInformPredicate.test(target) : false;

    protected Optional<LivingEntity> target = null;
    ...
    public Alert<E> canInform(Predicate<LivingEntity> predicate) {
    ...
    protected void start(E entity) {
        Iterable<LivingEntity> nearby = BrainUtil.getMemory(entity, MemoryModuleType.NEAREST_VISIBLE_LIVING_ENTITIES).findAll(this.canInformInternalPredicate);
